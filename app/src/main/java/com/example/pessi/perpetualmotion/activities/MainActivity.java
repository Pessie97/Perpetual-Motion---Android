package com.example.pessi.perpetualmotion.activities;
...
import com.example.pessi.perpetualmotion.R;
import com.example.pessi.perpetualmotion.lib.CardPilesAdapter;
import com.example.pessi.perpetualmotion.lib.Utils;
import com.google.gson.Gson;

import java.util.EmptyStackException;

import static com.example.pessi.perpetualmotion.lib.Utils.showInfoDialog;
import static com.example.pessi.perpetualmotion.lib.Utils.showYesNoDialog;

public class MainActivity extends AppCompatActivity
{
    private IDGame mCurrentGame; // current game object
    ...
    private void saveToSharedPref ()
    {
        ...
        // clear whatever is in the file right now
        editor.clear ();
    ...
    private final CardPilesAdapter.OIClickListener
            listener2 = new CardPilesAdapter.OIClickListener ()
    {
